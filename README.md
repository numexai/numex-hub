...
<img src="gorseller/banner.png" alt="Numex Hub — Deponu bilen yapay zekâ" width="100%">
...
flowchart LR
    ...
    MARKET[🛍️ Market · 44 açık kaynak uygulama] -->|kaynak kodu| FORGE
    HUB -->|Topluluk · çatalla| USER([👤 Sen])
```
